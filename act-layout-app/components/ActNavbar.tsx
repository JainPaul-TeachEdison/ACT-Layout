...
function ActNavbar() {
  return (
    <nav className="flex gap-[2px] bg-[#1b3144] px-[10px] py-[4.7px] items-center justify-between">
      <img
      ...
      <div>
        {" "}
        <a
          className="inline-flex items-center gap-x-2 text-sm font-semibold whitespace-nowrap text-blue-600 hover:text-blue-70 focus:outline-none focus:text-blue-700 dark:text-blue-500 dark:focus:text-blue-400"
          href="#"
          aria-current="page"
        >
          Active
        ...
        <a
          className="inline-flex items-center gap-x-2 text-sm whitespace-nowrap text-blue-600 hover:text-blue-70 focus:outline-none focus:text-blue-700 dark:text-blue-500 dark:focus:text-blue-400"
          href="#"
        >
          Link
        </a>
